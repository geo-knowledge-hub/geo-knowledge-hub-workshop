...
# Classification
probabilities_file <- "data/classification_map/ro_cube_20LKP_probs.rds"

# DL Model
ltae_model_file <- "data/model/ltae_model_trained.rds"
...
# Output directory
output_dir <- "data/classification_map_smooth"
